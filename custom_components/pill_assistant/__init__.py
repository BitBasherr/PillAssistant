...
STORAGE_VERSION = const_module.STORAGE_VERSION
STORAGE_KEY = const_module.STORAGE_KEY
LOG_FILE_NAME = const_module.LOG_FILE_NAME
SERVICE_TAKE_MEDICATION = const_module.SERVICE_TAKE_MEDICATION
SERVICE_SKIP_MEDICATION = const_module.SERVICE_SKIP_MEDICATION
SERVICE_REFILL_MEDICATION = const_module.SERVICE_REFILL_MEDICATION
SERVICE_TEST_NOTIFICATION = const_module.SERVICE_TEST_NOTIFICATION
SERVICE_SNOOZE_MEDICATION = const_module.SERVICE_SNOOZE_MEDICATION
ATTR_MEDICATION_ID = const_module.ATTR_MEDICATION_ID
ATTR_SNOOZE_DURATION = const_module.ATTR_SNOOZE_DURATION
CONF_MEDICATION_NAME = const_module.CONF_MEDICATION_NAME
CONF_DOSAGE = const_module.CONF_DOSAGE
CONF_DOSAGE_UNIT = const_module.CONF_DOSAGE_UNIT
CONF_REFILL_AMOUNT = const_module.CONF_REFILL_AMOUNT
CONF_NOTIFY_SERVICES = const_module.CONF_NOTIFY_SERVICES
DEFAULT_SNOOZE_DURATION_MINUTES = const_module.DEFAULT_SNOOZE_DURATION_MINUTES
ATTR_DOSES_TODAY = getattr(const_module, "ATTR_DOSES_TODAY", "doses_today")
ATTR_TAKEN_SCHEDULED_RATIO = getattr(
    const_module, "ATTR_TAKEN_SCHEDULED_RATIO", "taken_scheduled_ratio"
)
ATTR_LOG_FILE = getattr(const_module, "ATTR_LOG_FILE", "log_file")
