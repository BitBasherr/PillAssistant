...
async def setup_multiple_medications(hass: HomeAssistant):
    ...
    entry1 = MockConfigEntry(
        ...
        data={
            ...
            CONF_SCHEDULE_TIMES: [(datetime.now() + timedelta(hours=1)).strftime("%H:%M")],
    ...
    entry2 = MockConfigEntry(
        ...
        data={
            ...
            CONF_SCHEDULE_TYPE: "fixed_time",
            CONF_SCHEDULE_TIMES: [(datetime.now() + timedelta(hours=3)).strftime("%H:%M")],
            CONF_SCHEDULE_DAYS: ["mon", "tue", "wed", "thu", "fri", "sat", "sun"],
    ...
    entry3 = MockConfigEntry(
        ...
        data={
            ...
            CONF_SCHEDULE_TYPE: "fixed_time",
            CONF_SCHEDULE_TIMES: [(datetime.now() + timedelta(minutes=30)).strftime("%H:%M")],
            CONF_SCHEDULE_DAYS: ["mon", "tue", "wed", "thu", "fri", "sat", "sun"],
